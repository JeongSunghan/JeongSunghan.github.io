      ...
      <section className="about-section" id="about">
        <div className="about-wrapper">
          <div className="about-text">
            <h2>About Me</h2>
            <p>
              React와 Java, Spring Boot로 여러 프로젝트를 완주하며
              웹 프론트 및 백엔드 전반을 경험한 주니어 개발자입니다. <br/>
              <br/>
              아이디어가 생각나면 초안 작성 후, 바로 구현해보는 것을 선호하는 편입니다. 프로젝트를 진행하면서
              팀원과의 협업을 중요시하며 의견을 경청하고 존중하는
